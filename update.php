...
<form method="post" action="update-process.php">
    <fieldset>
        ...
        <p><label>code<br><input type="text" name="code" value="<?= $res["code"]?>"></label></p>
        <p><label>name<br><input type="text" name="name" value="<?= $res["name"]?>"></label></p>
        <p><label>point<br><input type="number" name="point" value="<?= $res["point"]?>"></label></p>
